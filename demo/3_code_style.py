...
# plotting related, but can regard as general
import seaborn as sns
from matplotlib import pyplot as plt

# ML related specific packages
from sklearn.metrics import accuracy_score, roc_auc_score

# user defined modules
from src.private_package import hello_world
import src.private_package

pd.__version__
hello_world()
src.private_package.hello_world()

# NOTE: (optional) user defined modules is location relevant to 
